 ...
 */
public class ZVXGW008_SRV_EntitiesLoginAsyncTask extends AsyncTask<Void, Void, Boolean> 
{
	...
	private static final String TAG = "ZVXGW008_SRV_EntitiesLoginAsyncTask";
	 ...
	 */
	public ZVXGW008_SRV_EntitiesLoginAsyncTask(ILoginAsyncTask activity, Context context, String userName, String password, String vaultPassword, String vaultSalt) 
	{
	...
	protected Boolean doInBackground(Void... arg0) 
	{
		...
		try
        {
			result = ZVXGW008_SRV_EntitiesRequestHandler.getInstance(context).executeLoginUsernamePassword(userName, password, vaultPassword, vaultSalt);
        } 
